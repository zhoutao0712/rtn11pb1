...
function show_banner(L3){// L3 = The third Level of Menu
	...
	if (spirit_logo_support)
		...
		banner_code +='<div style="margin-top:13px;margin-left:128px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top">ZHTEL RT-N11P_B1</span></div>';
	}
